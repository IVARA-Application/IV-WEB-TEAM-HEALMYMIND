      ...
      <div className="footer py-2">
        <div className=" block lg:flex lg:justify-around">
          <div className=" flex justify-center items-center flex-col flex-1">
            ...
            <h1 className="text-lg md:text-2xl text-center xl:text-left my-4 lg:mt-16 md:tracking-wide md:leading-8">
              Connect with us through <br /> WhatsApp at 24 x 7
            </h1>
          </div>
          <div className="flex-1  lg:border-solid lg:border-white lg:border-l-2 lg:border-r-2 lg:px-8 xl:px-24 lg:my-8">
          ...
          <div className="text-xl lg:text-2xl text-center mt-4 lg:mt-20 flex-1 underline">
